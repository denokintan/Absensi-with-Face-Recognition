...
# judul
judul = tk.Label(root, text="Face Recognition Absensi", font=("Roboto",34),bg="#242526", fg="white")
canvas.create_window(350, 80, window=judul)
#credit
made = tk.Label(root, text="Made by Denok Intan", font=("Times New Roman",13), bg="black",fg="white")
